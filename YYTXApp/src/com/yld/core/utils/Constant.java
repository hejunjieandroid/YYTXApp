...
public class Constant extends Application {
	 ...
	 * @brief 会话超时错误码
	 * */
	public static String UserTimeout = "-1";
	/**
	...
	public static final String KEY_USER_MOBILEPHONE = "MobilePhone";// 用户信息报文
																	// 手机号字段
	...
	public static final String KEY_USER_ISSMSAUTH = "_AuthenticateType";// 用户信息确认报文
																		// 是否需要短信验证码字段
																		// 000010：判断第五位
																		// 1：需要
																		// 0：不需要
	...
	public static final String KEY_TOKENMESSAGE = "TokenMessage";// 报文
																	// 短信验证码标示字段TokenMessage
	public static final String KEY_EXISTCHECKFLAG = "ExistCheckFlag";// 报文
																		// 短信验证码字段
	...
	public static final String TokenMessage_LoginPw = "sms.updatepassword.msg";// 短信验证码时短信内容
																				// 登录密码修改
	public static final String TokenMessage_TradePw = "sms.modtrspassword.msg";// 短信验证码时短信内容
																				// 交易密码修改
	public static final String TokenMessage_UserInfo = "sms.UpdateInfo.U";// 短信验证码时短信内容
																			// 个人信息变更
	public static final String TokenMessage_TransferOut = "sms.TransferOut.P";// 资金转出发送短信
																				// 资金转出
	public static final String TokenMessage_Register = "sms.RegisterPre.P";// 资金转出发送短信
																			// 注册
	public static final String TokenMessage_FindPw = "sms.findPassword.P";// 资金转出发送短信
																			// 密码找回
	public static final String TokenMessage_ChangePhone = "sms.ChangePhoneNo.P";// 资金转出发送短信
																				// 变更手机号
	public static final String TokenMessage_ChangeCard = "sms.ChangeBindCard.P";// 资金转出发送短信
																				// 变更绑定卡
