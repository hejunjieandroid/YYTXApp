...
public class PullToRefreshView extends LinearLayout {
	 ...
	 * footer view tv
	 */
	private TextView pull_to_load_tv;
	...
	private void addFooterView() {
		...
		pull_to_load_tv=(TextView) mFooterView.findViewById(R.id.pull_to_load_tv);
...
//				headerPrepareToRefresh(deltaY);
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
			...
			mFooterState = RELEASE_TO_REFRESH;
			pull_to_load_tv.setText("松手后刷新");
		} else if (Math.abs(newTopMargin) < (mHeaderViewHeight + mFooterViewHeight)) {
			mFooterImageView.clearAnimation();
			mFooterImageView.startAnimation(mFlipAnimation);
			mFooterState = PULL_TO_REFRESH;
			pull_to_load_tv.setText("上拉刷新");
		}
	}
	...
	private void footerRefreshing() {
		...
		pull_to_load_tv.setVisibility(View.GONE);
	...
	public boolean onFooterRefreshComplete() {
		...
		pull_to_load_tv.setVisibility(View.VISIBLE);
